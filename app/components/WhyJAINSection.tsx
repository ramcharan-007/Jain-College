...
const WhyJAINSection = () => {
  ...
  const reasons = [
    ...
    },
    {
      ...
      content:
        "Our campus features state-of-the-art facilities including smart classrooms, science labs, sports complexes, auditoriums, and modern learning spaces.",
    },
    {
      title: "Comprehensive Curriculum",
      content:
        "We offer a variety of PUC streams including Science, Commerce, and Arts/Humanities, preparing students for admission to top universities.",
    },
    {
      title: "Experienced Faculty",
      content:
        "Our team of highly qualified educators brings diverse expertise and a passion for teaching, ensuring personalized attention to every student.",
    },
    {
      title: "Co-Curricular Excellence",
      content:
        "From sports to arts, music to drama, robotics to debate - we offer numerous clubs and activities that help students discover and develop their passions.",
    },
  ];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl lg:text-4xl font-bold text-[#001C54] mb-4">
            Why JAIN College is Among the Best PU Colleges?
          </h2>
          <div className="w-24 h-1 bg-[#F8C300] mx-auto rounded-full"></div>
          <p className="mt-6 text-gray-600 max-w-2xl mx-auto">
            Choosing the right college is crucial for your child&apos;s future.
            Here&apos;s why families across the country choose JAIN College
            Global Campus.
          </p>
        </div>
